...
"""autogenerated by genpy from lslidar_n301_msgs/LslidarN301Scan.msg. Do not edit."""
import codecs
import sys
...
class LslidarN301Scan(genpy.Message):
  _md5sum = "bcd29f667509c681a7820aacabe51d58"
  _type = "lslidar_n301_msgs/LslidarN301Scan"
...
"""
  ...
  _slot_types = ['float64','lslidar_n301_msgs/LslidarN301Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LslidarN301Scan, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lslidar_n301_msgs.msg.LslidarN301Point()
        _x = val1
        start = end
        end += 52
