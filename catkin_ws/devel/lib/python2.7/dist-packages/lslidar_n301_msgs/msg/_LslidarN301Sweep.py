...
"""autogenerated by genpy from lslidar_n301_msgs/LslidarN301Sweep.msg. Do not edit."""
import codecs
import sys
...
import lslidar_n301_msgs.msg
import std_msgs.msg

class LslidarN301Sweep(genpy.Message):
  _md5sum = "e0395900ded93e728803e208b8b88005"
  _type = "lslidar_n301_msgs/LslidarN301Sweep"
...
"""
  ...
  _slot_types = ['std_msgs/Header','lslidar_n301_msgs/LslidarN301Scan[16]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LslidarN301Sweep, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.scans is None:
        self.scans = [lslidar_n301_msgs.msg.LslidarN301Scan() for _ in range(16)]
    else:
      self.header = std_msgs.msg.Header()
      self.scans = [lslidar_n301_msgs.msg.LslidarN301Scan() for _ in range(16)]
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.scans = []
      for i in range(0, 16):
        val1 = lslidar_n301_msgs.msg.LslidarN301Scan()
        start = end
        end += 8
        ...
        for i in range(0, length):
          val2 = lslidar_n301_msgs.msg.LslidarN301Point()
          _x = val2
          start = end
          end += 52
