...
let LslidarN301Point = require('./LslidarN301Point.js');

//-----------------------------------------------------------

class LslidarN301Scan {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.points.forEach((val) => {
      bufferOffset = LslidarN301Point.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LslidarN301Scan(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.points[i] = LslidarN301Point.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LslidarN301Scan(null);
    ...
    if (msg.points !== undefined) {
      ...
      for (let i = 0; i < resolved.points.length; ++i) {
        resolved.points[i] = LslidarN301Point.Resolve(msg.points[i]);
      }
    }
    else {
      resolved.points = []
...
module.exports = LslidarN301Scan;
