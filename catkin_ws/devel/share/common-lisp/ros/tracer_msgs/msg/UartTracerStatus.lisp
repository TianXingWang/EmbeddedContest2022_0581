...
;//! \htmlinclude UartTracerStatus.msg.html

(cl:defclass <UartTracerStatus> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (motor_states
    ...
    :type (cl:vector tracer_msgs-msg:UartTracerMotorState)
   :initform (cl:make-array 2 :element-type 'tracer_msgs-msg:UartTracerMotorState :initial-element (cl:make-instance 'tracer_msgs-msg:UartTracerMotorState)))
...
(cl:defclass UartTracerStatus (<UartTracerStatus>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <UartTracerStatus>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'UartTracerStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tracer_msgs-msg:<UartTracerStatus> is deprecated: use tracer_msgs-msg:UartTracerStatus instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <UartTracerStatus>))
...
(cl:defmethod linear_velocity-val ((m <UartTracerStatus>))
...
(cl:defmethod angular_velocity-val ((m <UartTracerStatus>))
...
(cl:defmethod base_state-val ((m <UartTracerStatus>))
...
(cl:defmethod control_mode-val ((m <UartTracerStatus>))
...
(cl:defmethod fault_code-val ((m <UartTracerStatus>))
...
(cl:defmethod battery_voltage-val ((m <UartTracerStatus>))
...
(cl:defmethod motor_states-val ((m <UartTracerStatus>))
...
(cl:defmethod light_control_enabled-val ((m <UartTracerStatus>))
...
(cl:defmethod front_light_state-val ((m <UartTracerStatus>))
...
(cl:defmethod rear_light_state-val ((m <UartTracerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:rear_light_state-val is deprecated.  Use tracer_msgs-msg:rear_light_state instead.")
  (rear_light_state m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<UartTracerStatus>)))
    "Constants for message type '<UartTracerStatus>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <UartTracerStatus>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <UartTracerStatus>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motor_states)))
    (cl:dotimes (i 2)
    (cl:setf (cl:aref vals i) (cl:make-instance 'tracer_msgs-msg:UartTracerMotorState))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UartTracerStatus>)))
  "Returns string type for a message object of type '<UartTracerStatus>"
  "tracer_msgs/UartTracerStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UartTracerStatus)))
  "Returns string type for a message object of type 'UartTracerStatus"
  "tracer_msgs/UartTracerStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<UartTracerStatus>)))
  "Returns md5sum for a message object of type '<UartTracerStatus>"
  "7a49e199fd32bf5d7341d653c6b3ba6e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'UartTracerStatus)))
  "Returns md5sum for a message object of type 'UartTracerStatus"
  "7a49e199fd32bf5d7341d653c6b3ba6e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<UartTracerStatus>)))
  "Returns full string definition for message of type '<UartTracerStatus>"
  (cl:format cl:nil "Header header~%~%int8 MOTOR_ID_FRONT_RIGHT = 0~%int8 MOTOR_ID_FRONT_LEFT = 1~%int8 MOTOR_ID_REAR_RIGHT = 2~%int8 MOTOR_ID_REAR_LEFT = 3~%~%int8 LIGHT_ID_FRONT = 0~%int8 LIGHT_ID_REAR = 1~%~%# motion state~%float64 linear_velocity~%float64 angular_velocity~%~%# base state~%uint8 base_state~%uint8 control_mode~%uint16 fault_code~%float64 battery_voltage~%~%# motor state~%UartTracerMotorState[2] motor_states~%~%# light state~%bool light_control_enabled~%TracerLightState front_light_state~%TracerLightState rear_light_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: tracer_msgs/UartTracerMotorState~%float64 current~%float64 rpm~%float64 temperature~%~%================================================================================~%MSG: tracer_msgs/TracerLightState~%uint8 mode~%uint8 custom_value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'UartTracerStatus)))
  "Returns full string definition for message of type 'UartTracerStatus"
  (cl:format cl:nil "Header header~%~%int8 MOTOR_ID_FRONT_RIGHT = 0~%int8 MOTOR_ID_FRONT_LEFT = 1~%int8 MOTOR_ID_REAR_RIGHT = 2~%int8 MOTOR_ID_REAR_LEFT = 3~%~%int8 LIGHT_ID_FRONT = 0~%int8 LIGHT_ID_REAR = 1~%~%# motion state~%float64 linear_velocity~%float64 angular_velocity~%~%# base state~%uint8 base_state~%uint8 control_mode~%uint16 fault_code~%float64 battery_voltage~%~%# motor state~%UartTracerMotorState[2] motor_states~%~%# light state~%bool light_control_enabled~%TracerLightState front_light_state~%TracerLightState rear_light_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: tracer_msgs/UartTracerMotorState~%float64 current~%float64 rpm~%float64 temperature~%~%================================================================================~%MSG: tracer_msgs/TracerLightState~%uint8 mode~%uint8 custom_value~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <UartTracerStatus>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <UartTracerStatus>))
  "Converts a ROS message object to a list"
  (cl:list 'UartTracerStatus
