...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto 
...
class FastCorrelativeScanMatcherOptions3D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.scan_matching.proto.FastCorrelativeScanMatcherOptions3D) */ {
 public:
  ...
  inline FastCorrelativeScanMatcherOptions3D* New() const final {
    return CreateMaybeMessage<FastCorrelativeScanMatcherOptions3D>(NULL);
  }
