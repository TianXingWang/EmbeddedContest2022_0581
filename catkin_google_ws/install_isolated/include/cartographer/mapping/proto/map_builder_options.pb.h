...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_cartographer_2fmapping_2fproto_2fmap_5fbuilder_5foptions_2eproto 
...
class MapBuilderOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.MapBuilderOptions) */ {
 public:
  ...
  inline MapBuilderOptions* New() const final {
    return CreateMaybeMessage<MapBuilderOptions>(NULL);
  }
