...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_cartographer_2fmapping_2fproto_2fconnected_5fcomponents_2eproto 
...
class ConnectedComponents_ConnectedComponent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ConnectedComponents.ConnectedComponent) */ {
 public:
  ...
  inline ConnectedComponents_ConnectedComponent* New() const final {
    return CreateMaybeMessage<ConnectedComponents_ConnectedComponent>(NULL);
  }
...
class ConnectedComponents : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ConnectedComponents) */ {
 public:
  ...
  inline ConnectedComponents* New() const final {
    return CreateMaybeMessage<ConnectedComponents>(NULL);
  }
