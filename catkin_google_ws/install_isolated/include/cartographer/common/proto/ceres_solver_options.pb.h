...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_cartographer_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto 
...
class CeresSolverOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.common.proto.CeresSolverOptions) */ {
 public:
  ...
  inline CeresSolverOptions* New() const final {
    return CreateMaybeMessage<CeresSolverOptions>(NULL);
  }
